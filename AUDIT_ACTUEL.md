...
11. `infrastructure/worldgen/biome/IrradiatedBiomes.java:26-40` — 5 commentaires français sur des choix esthétiques de biome (numéros de ligne re-décalés par `ae1e394d`/`6bc20956`, contenu inchangé) ; mineur. L'item §4 « template non terminé » lui-même est désormais clos (voir §4), seul le décalage de ces commentaires reste à suivre ici.
