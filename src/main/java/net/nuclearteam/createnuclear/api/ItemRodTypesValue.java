...
public class ItemRodTypesValue {
     ...
     */
    public static final RodType DEFAULT_ROD_TYPE = new RodType(HolderSet.direct(Collections.emptyList()), -1, -1, -1, RodType.TypeRod.MIXTE);
