package net.nuclearteam.createnuclear.CNMaths;

public class CNSimplexNoise {
    private static CNSimplexNoise.Grad[] grad3 = new CNSimplexNoise.Grad[]{new CNSimplexNoise.Grad(1.0, 1.0, 0.0), new CNSimplexNoise.Grad(-1.0, 1.0, 0.0), new CNSimplexNoise.Grad(1.0, -1.0, 0.0), new CNSimplexNoise.Grad(-1.0, -1.0, 0.0), new CNSimplexNoise.Grad(1.0, 0.0, 1.0), new CNSimplexNoise.Grad(-1.0, 0.0, 1.0), new CNSimplexNoise.Grad(1.0, 0.0, -1.0), new CNSimplexNoise.Grad(-1.0, 0.0, -1.0), new CNSimplexNoise.Grad(0.0, 1.0, 1.0), new CNSimplexNoise.Grad(0.0, -1.0, 1.0), new CNSimplexNoise.Grad(0.0, 1.0, -1.0), new CNSimplexNoise.Grad(0.0, -1.0, -1.0)};
    private static CNSimplexNoise.Grad[] grad4 = new CNSimplexNoise.Grad[]{new CNSimplexNoise.Grad(0.0, 1.0, 1.0, 1.0), new CNSimplexNoise.Grad(0.0, 1.0, 1.0, -1.0), new CNSimplexNoise.Grad(0.0, 1.0, -1.0, 1.0), new CNSimplexNoise.Grad(0.0, 1.0, -1.0, -1.0), new CNSimplexNoise.Grad(0.0, -1.0, 1.0, 1.0), new CNSimplexNoise.Grad(0.0, -1.0, 1.0, -1.0), new CNSimplexNoise.Grad(0.0, -1.0, -1.0, 1.0), new CNSimplexNoise.Grad(0.0, -1.0, -1.0, -1.0), new CNSimplexNoise.Grad(1.0, 0.0, 1.0, 1.0), new CNSimplexNoise.Grad(1.0, 0.0, 1.0, -1.0), new CNSimplexNoise.Grad(1.0, 0.0, -1.0, 1.0), new CNSimplexNoise.Grad(1.0, 0.0, -1.0, -1.0), new CNSimplexNoise.Grad(-1.0, 0.0, 1.0, 1.0), new CNSimplexNoise.Grad(-1.0, 0.0, 1.0, -1.0), new CNSimplexNoise.Grad(-1.0, 0.0, -1.0, 1.0), new CNSimplexNoise.Grad(-1.0, 0.0, -1.0, -1.0), new CNSimplexNoise.Grad(1.0, 1.0, 0.0, 1.0), new CNSimplexNoise.Grad(1.0, 1.0, 0.0, -1.0), new CNSimplexNoise.Grad(1.0, -1.0, 0.0, 1.0), new CNSimplexNoise.Grad(1.0, -1.0, 0.0, -1.0), new CNSimplexNoise.Grad(-1.0, 1.0, 0.0, 1.0), new CNSimplexNoise.Grad(-1.0, 1.0, 0.0, -1.0), new CNSimplexNoise.Grad(-1.0, -1.0, 0.0, 1.0), new CNSimplexNoise.Grad(-1.0, -1.0, 0.0, -1.0), new CNSimplexNoise.Grad(1.0, 1.0, 1.0, 0.0), new CNSimplexNoise.Grad(1.0, 1.0, -1.0, 0.0), new CNSimplexNoise.Grad(1.0, -1.0, 1.0, 0.0), new CNSimplexNoise.Grad(1.0, -1.0, -1.0, 0.0), new CNSimplexNoise.Grad(-1.0, 1.0, 1.0, 0.0), new CNSimplexNoise.Grad(-1.0, 1.0, -1.0, 0.0), new CNSimplexNoise.Grad(-1.0, -1.0, 1.0, 0.0), new CNSimplexNoise.Grad(-1.0, -1.0, -1.0, 0.0)};
    ...
    private static double dot(CNSimplexNoise.Grad g, double x, double y) {
        return g.x * x + g.y * y;
    }

    private static double dot(CNSimplexNoise.Grad g, double x, double y, double z) {
        return g.x * x + g.y * y + g.z * z;
    }

    private static double dot(CNSimplexNoise.Grad g, double x, double y, double z, double w) {
