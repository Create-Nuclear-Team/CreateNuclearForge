...
public class CNMath {
    ...
    public static float sampleNoise2D(int x, int z, float simplexSampleRate) {
        return (float)CNSimplexNoise.noise((double)(((float)x + simplexSampleRate) / simplexSampleRate), (double)(((float)z + simplexSampleRate) / simplexSampleRate));
    }

    public static float sampleNoise3D(int x, int y, int z, float simplexSampleRate) {
        return (float)CNSimplexNoise.noise((double)(((float)x + simplexSampleRate) / simplexSampleRate), (double)(((float)y + simplexSampleRate) / simplexSampleRate), (double)(((float)z + simplexSampleRate) / simplexSampleRate));
    }

    public static float sampleNoise3D(float x, float y, float z, float simplexSampleRate) {
        return (float)CNSimplexNoise.noise((double)((x + simplexSampleRate) / simplexSampleRate), (double)((y + simplexSampleRate) / simplexSampleRate), (double)((z + simplexSampleRate) / simplexSampleRate));
    }
