...
public class AntiRadiationArmorModel extends HumanoidModel<LivingEntity> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "d"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(30, 0).addBox(-4.0F, -4.075F, -3.875F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(30, 16).addBox(-4.0F, -3.925F, -4.125F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.5F)), PartPose.offset(0.05F, -3.775F, -0.175F));

		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 19).addBox(-3.875F, -5.875F, -2.65F, 8.0F, 12.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(45, 32).mirror().addBox(-2.1F, -6.0F, -1.9F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(45, 32).addBox(-2.1F, -5.95F, -1.9F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(29, 32).addBox(-1.9F, -6.05F, -2.1F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(6.2F, 6.05F, -0.2F));

		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(29, 48).mirror().addBox(-2.0733F, -7.4667F, -1.8667F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(29, 48).addBox(-1.9667F, -7.4667F, -1.8667F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
