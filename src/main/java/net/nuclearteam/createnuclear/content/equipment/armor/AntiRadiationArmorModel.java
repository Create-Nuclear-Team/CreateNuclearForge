...
//		this.left_boot = this.left_leg.getChild("power_boot");
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(61, 39).mirror().addBox(-1.9633F, 7.9667F, -2.0667F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.25F)).mirror(false), PartPose.offset(-1.6367F, 19.3333F, 0.7667F));
		...
		.texOffs(61, 39).addBox(-2.0167F, 7.9667F, -2.0667F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(2.2167F, 19.3333F, 0.7667F));
