...
public class NuclearExplosionEntity extends Entity {
    ...
    public NuclearExplosionEntity(PlayMessages.SpawnEntity spawnEntity, Level level) {
        this(CNEntityType.NUCLEAR_EXPLOSION.get(), level);
    ...
    public void tick() {
        ...
        if (!spawnedParticle) {
            ...
            level().addAlwaysVisibleParticle(ParticleTypes.CAMPFIRE_SIGNAL_SMOKE, true, this.getX(), particleY + 2, this.getZ(), this.getSize(), isIntentionalGameDesign() ? 1.0F : 0.0F, 0);
        }
