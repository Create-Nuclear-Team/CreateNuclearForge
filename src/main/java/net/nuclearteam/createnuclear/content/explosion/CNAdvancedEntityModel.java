...
public abstract class CNAdvancedEntityModel<T extends Entity> extends CNBasicEntityModel<T> {
    ...
    public void faceTarget(float yaw, float pitch, float rotationDivisor, CNAdvancedModelBox... boxes) {
        ...
        for(CNAdvancedModelBox box : boxes) {
    ...
    public void chainSwing(CNAdvancedModelBox[] boxes, float speed, float degree, double rootOffset, float swing, float swingAmount) {
    ...
    public void chainWave(CNAdvancedModelBox[] boxes, float speed, float degree, double rootOffset, float swing, float swingAmount) {
        float offset = this.calculateChainOffset(rootOffset, boxes);
    ...
    public void chainFlap(CNAdvancedModelBox[] boxes, float speed, float degree, double rootOffset, float swing, float swingAmount) {
        float offset = this.calculateChainOffset(rootOffset, boxes);
    ...
    private float calculateChainOffset(double rootOffset, CNAdvancedModelBox... boxes) {
    ...
    public void walk(CNAdvancedModelBox box, float speed, float degree, boolean invert, float offset, float weight, float walk, float walkAmount) {
        box.walk(speed, degree, invert, offset, weight, walk, walkAmount);
    }

    public void flap(CNAdvancedModelBox box, float speed, float degree, boolean invert, float offset, float weight, float flap, float flapAmount) {
        box.flap(speed, degree, invert, offset, weight, flap, flapAmount);
    }

    public void swing(CNAdvancedModelBox box, float speed, float degree, boolean invert, float offset, float weight, float swing, float swingAmount) {
        box.swing(speed, degree, invert, offset, weight, swing, swingAmount);
    }

    public void bob(CNAdvancedModelBox box, float speed, float degree, boolean bounce, float f, float f1) {
    ...
    public void progressRotationPrev(CNAdvancedModelBox model, float progress, float rotX, float rotY, float rotZ, float divisor) {
        model.rotateAngleX += progress * rotX / divisor;
        model.rotateAngleY += progress * rotY / divisor;
        model.rotateAngleZ += progress * rotZ / divisor;
    }

    public void progressPosition(CNAdvancedModelBox model, float progress, float x, float y, float z, float divisor) {
    ...
    public void progressPositionPrev(CNAdvancedModelBox model, float progress, float x, float y, float z, float divisor) {
